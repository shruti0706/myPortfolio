...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://formsubmit.co/shruti762001@gmail.com', {
        method: 'POST',
        headers: {
          ...
          <div className="flex-1 min-w-[280px]">
            ...
            <div className="mt-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:shruti762001@gmail.com" className="hover:text-primary transition-colors">
                  shruti762001@gmail.com
                </a>
              </div>
              <div className="flex items-center gap-3">
                <FaLinkedin className="text-primary" />
                <a href="https://www.linkedin.com/in/shruti-agrawal-762001/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  linkedin.com/in/shrutiagrawal
                </a>
              </div>
              <div className="flex items-center gap-3">
                <FaGithub className="text-primary" />
                <a href="https://github.com/shruti0706" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  github.com/shruti0706
                </a>
              </div>
            </div>
          </div>
